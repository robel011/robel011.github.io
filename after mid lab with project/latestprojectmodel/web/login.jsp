...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  ...
  <body >
  <h1>  HUBY-WIFEE Electronic and Devices Online Shopping  </h1>
  ...
  <h3 > If you are  a new Customer please sign Up first</h3>
  ...
  <form>
     ...
     <h3> If you want to buy from our shop for any claim or to see more product and other <br>staffs, We have a list of addresses and  Come to the given Address close to you!!<br> for</h3>
<%--       Address: <input type="text" name="city">--%>

<div>
  <select id="address">
      <option value="" selected="selected">(choose a City)</option>
      <option value="DEN.txt">Denver</option>
  ...
  <div>
      <textarea id="output" rows="16" cols="40"></textarea>
  </div>
